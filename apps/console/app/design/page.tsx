...
/* Specimen sheet for the design substrate, at /design.
 *
 * This is deliberately not a mock console. It exists so the tokens can be
 * looked at directly and caught drifting.
 *
 * It used to be the site root, on the argument that the first thing deployed
 * from `main` should be an honest artefact rather than a placeholder
 * pretending to be product. That was right while there was no product to
 * show and wrong once there was: a visitor arriving at Lighthouse got a colour
 * specimen and no way to tell what any of it was for.
 *
